...
//             <thead className="sticky top-0 bg-gray-200 text-gray-700 text-xs shadow z-10">
//               <tr>
//                 <th className="py-2 px-3 text-center border">S.No.</th>
//                 <th className="py-2 px-3 text-center border">
//                   Item Name,Model <br /> & Category{" "}
//                 </th>
//                 <th className="py-2 px-3 text-center border">
//                   Item <br /> (Store)
//                 </th>
...
//                     <p>{record.itemName}</p>
//                     <p className=" text-xs">({record.model})</p>
//                     <p className=" text-xs">{record.category}</p>
//                   </td>
//                   <td className="py-2 px-3 text-center border">
...
//                       "pending(add)",
//                       "pending(remove)",
//                       "pending(remove_fault_store)",
//                       "pending(remove_fault_use)",
//                       "pending(transfer)",
