    ...
    <div className="min-h-screen flex items-center justify-center bg-green-200">
      <div className="max-w-xl mx-auto p-6 bg-white shadow-2xl rounded-md">
        <div className="flex items-center justify-center text-xl font-bold bg-gradient-to-r from-purple-300 via-purple-400 to-purple-600 rounded-xl shadow-xl mb-5 p-4">
          <h2 className="ml-2 text-center">
            Store Management System for the Engineering Section of Bangladesh
            Betar
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="relative  mb-8">
            ...
            <div
              className="absolute inset-0 bg-center lg:bg-cover bg-[length:160px_160px] bg-no-repeat"
              style={{
            ...
            <div className="relative z-10 text-center  my-12 lg:my-0">
              <h4 className="text-4xl font-bold  text-emerald-800">
                Welcome Back!
              </h4>
              <p className="text-base font-semibold">
                Log in to manage items, services and access operations.
              </p>
            </div>
          </div>
          ...
          <div className="">
            ...
            <p className="text-center mt-3 text-sm">
              ...
              <button className="text-blue-500" onClick={handleOpenResetModal}>
                Reset it here
              </button>
            </p>
          </div>
        ...
        <div className="space-y-4">
          <div className="flex justify-center gap-4 mt-8">
            <Link
              to="/contact"
              className="text-sm font-medium text-indigo-900 hover:underline border-r-2 border-black pr-4"
            >
              Contact
            </Link>
            <Link
